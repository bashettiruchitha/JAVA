...
class Home {
    ...
    void startTheJourney() throws SpeedBreaksException {
...
class Car {
    ...
    void longDrive() throws BreakOilException, SpeedBreaksException {
        for (int i = 1; i <= 50; i++) {
            ...
            if (val > 0.11 && val < 0.20) {
                throw new BreakOilException("ohh breakoil  ......");

            }
            if (val > 0.90 && val < 0.99) {

                throw new SpeedBreaksException("speed limit exceeds");
...
class BreakOilException extends Exception {

    BreakOilException(String msg) {
        super(msg);
    }
}

class SpeedBreaksException extends Exception {

    SpeedBreaksException(String msg) {
